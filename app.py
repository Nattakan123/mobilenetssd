...
lineaccesstoken = 'P/9MjtZdJs75LeNlcZBGNhvQJIyAZmsl3Yp2PIPuZVFc/Td6Nqlg44Q7NsY1L08FYg26eIJ51UZtpX0PlcqbV/RvaMVozI+d4JsmNv3y17/zQPhmjtQEKXQEyT/+ZfvWRVgI3VPzSPF/e0F1rZ0JWAdB04t89/1O/w1cDnyilFU='
...
def event_handle(event):
    ...
    if msgType == "text":
        ...
        if (msg == "สวัสดี") :
            replyObj = TextSendMessage(text="ว่าไงคะ")
        elif (msg == "กินข้าวมั้ย") :
            replyObj = TextSendMessage(text="เอาสิ")   
        elif (msg == "ไปเที่ยวมั้ย") :
            replyObj = TextSendMessage(text="ไปสิคะ")
        else :
        line_bot_api.reply_message(rtoken, replyObj)
    elif msgType == "image":
        try:
